<!DOCTYPE html> <!-- I know it's a php file but it looked weird in my browser (scroll) without saying this-->
<html> 
	<head> 
		<title>TIMS: Home</title> <!-- this is what will appear in the browser title bar-->
	...
	<body>
		...
		<div class="content"> <!-- this class stores the main content in my home page -->
			...
			<h1 class="centre-heading">Traffic Incident Management System</h1> <!-- heading 1. The main heading on our home page styled to be centred using a class "center-text" -->
			...
			<img src="images/uon.png" alt="University of Nottingham Logo" class="uon-logo"> <!-- university of nottingham logo. For this image anx the one above, their respective classes are used for styling-->
